import { IWeatherData, ParseDataForWeather } from "../entity";
...
export const getCurrentWeather = async (city: string): Promise<ParseDataForWeather> => {
    ...
    return ParseDataForWeather.createFromResponse(data);
}; 
